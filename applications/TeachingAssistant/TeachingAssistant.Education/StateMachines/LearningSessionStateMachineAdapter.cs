...
/// <summary>
/// Adapter that wraps a state machine instance to implement ILearningSessionStateMachine.
/// Uses reflection to avoid direct dependency on IStateMachine.
/// </summary>
/// <typeparam name="TState">The type of the state context.</typeparam>
public class LearningSessionStateMachineAdapter<TState> : ILearningSessionStateMachine<TState> where TState : class
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LearningSessionStateMachineAdapter{TState}"/> class.
    /// </summary>
    ...
    public LearningSessionStateMachineAdapter(object stateMachine)
    {
